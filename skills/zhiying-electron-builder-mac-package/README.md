# Electron 打包避坑指南 · zhiying-electron-builder-mac-package

> Electron 应用在 macOS 沙箱环境下的打包避坑指南：构建异常处置、产物校验、无签名自研更新器与真机验证。

![效果预览](./preview.jpg)

`开发工具` `v1.0.1` `Agent Skills 标准` `MIT`

## 📥 安装

| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「Electron 打包避坑指南」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
