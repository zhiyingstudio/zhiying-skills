# 视频自动剪辑 · zhiying-auto-video-edit

> 基于 ffmpeg 的视频自动剪辑流水线：智能去静音、批量剪切、场景抽片段、字幕烧录、片头片尾拼接、背景音乐混音。
...
| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「视频自动剪辑」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
...
技能指令正文见 [SKILL.md](SKILL.md)。附带资源目录：`assets/`、`references/`、`scripts/`。
