# 周报与任务拆解 · zhiying-weekly-report

> 证据驱动的周报生成：git log+任务清单→结构化周报，附 WBS 拆解到可执行粒度的方法与 8 个风险预警信号。

![效果预览](./preview.jpg)

`项目管理` `v1.0.1` `Agent Skills 标准` `MIT`

## 📥 安装

| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「周报与任务拆解」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
