# 上线前全端深度测试 · zhiying-prelaunch-fullstack-test

> 上线前最后一轮全端深度测试：并行子代理分端穷举 UI/API/代码三层，汇总 P0-P3 分级报告与上线结论。
...
| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「上线前全端深度测试」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
