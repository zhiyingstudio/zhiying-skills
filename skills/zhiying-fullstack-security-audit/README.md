# 全栈安全审查 · zhiying-fullstack-security-audit

> 上线 Web 项目的全栈安全与质量审查：并行子代理分域深挖 + 主代理独立复现 P0 + 分级整改清单，含 30+ 真实漏洞模式速查表。

![效果预览](./preview.jpg)

`安全合规` `v1.0.1` `Agent Skills 标准` `MIT`

## 📥 安装

| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「全栈安全审查」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
