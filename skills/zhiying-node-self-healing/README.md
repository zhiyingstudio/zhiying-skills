# 节点自愈运维 · zhiying-node-self-healing

> AI 推理节点稳定性加固：任务计数预防性回收 + 秒级崩溃自愈 + 孤儿进程树清理，含常驻监督脚本模板与全部参数陷阱。

![效果预览](./preview.jpg)

`系统运维` `v1.0.1` `Agent Skills 标准` `MIT`

## 📥 安装

| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「节点自愈运维」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
