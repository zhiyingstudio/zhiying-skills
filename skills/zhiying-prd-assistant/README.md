# PRD 写作与评审 · zhiying-prd-assistant

> 一句话需求→结构完整 PRD：背景目标、用户故事、功能清单、边界异常、数据指标六段式，附二义性排查与 UI 走查清单。

`需求设计` `v1.0.1` `Agent Skills 标准` `MIT`

## 📥 安装

| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「PRD 写作与评审」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
