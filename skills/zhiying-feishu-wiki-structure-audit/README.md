# 飞书知识库体检 · zhiying-feishu-wiki-structure-audit

> 飞书知识库结构审查：BFS 全量盘点节点树、导航死链校验、零宽字符标题检测、重复与空板块识别。

![效果预览](./preview.jpg)

`办公协同` `v1.0.1` `Agent Skills 标准` `MIT`

## 📥 安装

| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「飞书知识库体检」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
...
技能指令正文见 [SKILL.md](SKILL.md)。附带资源目录：`scripts/`。
