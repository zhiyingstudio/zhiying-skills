# 数据诚实审查 · zhiying-data-honesty-audit

> 审查给客户看的数字是否诚实：揪出假回退、编造因果、自证循环三类数据造假反模式。

`数据分析` `v1.0.1` `Agent Skills 标准` `MIT`

## 📥 安装

| 工具 | 方式 |
| --- | --- |
| **WorkBuddy** | 推荐市场搜索「数据诚实审查」一键安装，或把本目录复制到 `~/.workbuddy/skills/` |
